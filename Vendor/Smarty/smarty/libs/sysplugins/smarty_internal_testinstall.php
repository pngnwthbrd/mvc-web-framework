...
class Smarty_Internal_TestInstall
{
    ...
    public static function testInstall(Smarty $smarty, &$errors = null)
    {
        ...
        if ($errors === null) {
            echo "<PRE>\n";
            echo "Smarty Installation public...\n";
            echo "Testing template directory...\n";
        }
        $_stream_resolve_include_path = function_exists('stream_resolve_include_path');
        // public if all registered template_dir are accessible
        ...
        // public if registered compile_dir is accessible
        ...
        // public if all registered plugins_dir are accessible
        ...
        // public if all registered cache_dir is accessible
        ...
        // public if all registered config_dir are accessible
        ...
        // public if sysplugins are available
        ...
        // public if core plugins are available
